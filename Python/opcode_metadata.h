...
enum InstructionFormat { INSTR_FMT_IB, INSTR_FMT_IBC, INSTR_FMT_IBC00, INSTR_FMT_IBC000, INSTR_FMT_IBC00000000, INSTR_FMT_IBC00000000000000000000, INSTR_FMT_IBIB, INSTR_FMT_IX, INSTR_FMT_IXC, INSTR_FMT_IXC000 };
...
const struct opcode_metadata _PyOpcode_opcode_metadata[256] = {
    ...
    [LOAD_ATTR] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_INSTANCE_VALUE] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_MODULE] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_WITH_HINT] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_SLOT] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_CLASS] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_PROPERTY] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN] = { true, INSTR_FMT_IBC00000000000000000000 },
    ...
    [LOAD_ATTR_METHOD_WITH_VALUES] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_METHOD_NO_DICT] = { true, INSTR_FMT_IBC00000000000000000000 },
    [LOAD_ATTR_METHOD_LAZY_DICT] = { true, INSTR_FMT_IBC00000000000000000000 },
